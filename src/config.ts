...
// ─── Brand Identity ───────────────────────────────────────────────────────────
export const BRAND_NAME       = "Pelle Heating";          // e.g. "AirPro"
export const BRAND_FULL_NAME  = "Pelle Heating & Air Conditioning";           // e.g. "AirPro Heating & Air Conditioning"
export const BRAND_LEGAL_NAME = "Pelle Heating & Air Conditioning";          // e.g. "AirPro Heating & Air Conditioning, Inc."
...
export const BRAND_INITIALS   = "PHA";             // e.g. "AP" — used in decorative elements

// ─── Contact ──────────────────────────────────────────────────────────────────
export const PHONE_LABEL  = "(408) 800-2791";   // e.g. "(408) 898-6999"
export const PHONE_TEL    = "tel:14088002791";  // e.g. "tel:14088986999"
export const BRAND_EMAIL  = "info@pelleheatandairconditioning.com";                    // e.g. "info@airpro.com"
export const BRAND_ADDRESS = "1045 N 10th St San Jose CA 95112";                 // e.g. "1593 Trieste Way, San Jose, CA 95122"
...
export const PRIMARY_COLOR   = "#04295D";   // brand accent — buttons, links, gold
...
export const SEO_TITLE       = "Pelle Heating & Air Conditioning — San Jose HVAC";
export const SEO_DESCRIPTION = "Pelle Heating & Air Conditioning — San Jose's trusted HVAC professionals. Professional HVAC Service & Repair in San Jose.";
...
export const HERO_CTA_SECONDARY = "Call 408) 800-2791";   // patched to PHONE_LABEL
export const HERO_SIDE_RAIL_TEXT = "Serving Santa Clara County";
export const HERO_IMG_ALT       = "Pelle Heating & Air Conditioning technician servicing a residential HVAC system in San Jose";
...
export const TRUST_PILLARS = [
  ...
  {
    num: "04",
    eyebrow: "The Pelle Heating Promise",
...
export const TESTIMONIALS = [
  {
    quote: "Charles was great, I appreciate your timely support and diagnosis.",
    author: "Anthony Anderson",
    role: "Google Review · 5★",
  },
  {
    quote: "Timely and comprehensive analysis of dated HVAC and water heater systems.",
    author: "Ted Kitada",
    role: "Google Review · 5★",
  },
  {
    quote: "Pelle is one of the best service and installation businesses I've ever worked with.",
    author: "Leslie Parks",
    role: "Google Review · 5★",
  },
  {
    quote: "So professional, knowledgeable, thorough and friendly.",
    author: "Loreen Adams",
    role: "Google Review · 5★",
  }
];
...
export const FAQ_ITEMS = [
  {
    ...
    a: `Yes — Pelle Heating & Air Conditioning has been proudly serving the area for years. Most appointments are booked the same week you call, and our service call department is open Monday through Friday, 8:00 AM – 5:00 PM.`,
  },
  {
    q: "Are you licensed, bonded, and insured?",
    a: `Absolutely. Pelle Heating & Air Conditioning is fully licensed, bonded, and insured. Every technician on our team is trained, professional, and treats your home with respect.`,
  },
  {
  ...
  },
  {
    ...
    a: "We provide AC Installation, AC Repairs, AC Maintenance, Furnace Installation, Furnace Repairs, Furnace Maintenance — for both residential and commercial properties. Installations, replacements, repairs, and maintenance are all covered.",
  },
  {
